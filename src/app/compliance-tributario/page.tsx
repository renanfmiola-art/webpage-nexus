            ...
            <div className="max-w-4xl space-y-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-16 border-t border-white/5">
                    ...
                    <div className="md:col-span-2 space-y-6 text-white/60 text-lg leading-relaxed">
                        <p className="text-white font-medium">{tf.what_is.p1}</p>
                        <p>{tf.what_is.p2}</p>
                        {tf.what_is.p3 && <p>{tf.what_is.p3}</p>}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-16 border-t border-white/5">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <p className="text-white/60 text-lg leading-relaxed">{tf.for_whom.p1}</p>
                        <ul className="space-y-4">
                            {tf.for_whom.items.map((item: string, i: number) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-16 border-t border-white/5">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <p className="text-white font-medium text-lg leading-relaxed">{tf.problem.p1}</p>
                        <ul className="space-y-4">
                            {tf.problem.items.map((item: string, i: number) => (
                                <li key={i} className="flex items-start gap-4 text-white/60 text-lg group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-white/20 mt-3 group-hover:bg-white/40 transition-colors" />
                                    <span>{item}</span>
                                </li>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-16 border-t border-white/5">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {tf.is_not.items.map((item: string, i: number) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-16 border-t border-white/5">
                    <div className="md:col-span-1">
                        <h2 className="text-[10px] font-bold tracking-[0.5em] uppercase text-white/40 border-l-2 border-white/10 pl-4">
                            {tf.how_it_works.title}
                        </h2>
                    </div>
                    <div className="md:col-span-2 space-y-12">
                        <p className="text-white/60 text-lg leading-relaxed">{tf.how_it_works.p1}</p>
                        <div className="space-y-12">
                            {tf.how_it_works.steps.map((step: any, i: number) => (
