...
export const metadata = {
    title: "Privacy Policy | Nexus Intelligence",
    description: "Declaration of our privacy policy and compliance with the LGPD.",
        ...
        return (
            <section className="bg-background py-16 md:py-24">
                <Container className="max-w-4xl">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-primary mb-8 tracking-tight">Privacy Policy</h1>
                    <div className="prose prose-slate max-w-none text-muted-foreground prose-headings:text-primary prose-a:text-accent">
                        <p className="lead">
                            <strong>Nexus Intelligence</strong> ("we", "our") is committed to protecting your privacy and ensuring that your personal and tax data are treated in absolute compliance with the Brazilian General Data Protection Law (LGPD - nº 13.709/2018).
                        </p>

                        <h2>1. Data Collected</h2>
                        <p>
                            We collect essential information for the execution of our tax consulting services. This includes registration data provided at the time of contact (name, email, phone, title, company) and, when feasible through a formal contract (NDA), anonymized transactional/tax data for preliminary analysis. For site navigation, we automatically collect analytical cookies.
                        </p>

                        <h2>2. Purpose of Processing</h2>
                        <p>We use the data to:</p>
                        <ul>
                            <li>Provide answers and quotes about our tax services.</li>
                            <li>Comply with tax audit and compliance service contracts.</li>
                            <li>Send relevant institutional communications, with an opt-out option available.</li>
                            <li>Improve the user browsing experience through access metrics (Google Analytics 4).</li>
                        </ul>

                        <h2>3. Legal Basis</h2>
                        <p>
                            The processing is supported by the LGPD under the following precepts: Execution of contract or preliminary procedures (Art. 7, V) concerning recovery and analysis services; and Legitimate Interest (Art. 7, IX) for institutional communications to potential clients (B2B).
                        </p>

                        <h2>4. Data Subject Rights</h2>
                        <p>You, as the data subject, have the following rights guaranteed by art. 18 and following of the LGPD:</p>
                        <ul>
                            ...
                            <li>Anonymization, blocking, or elimination of unnecessary, excessive, or improperly processed data.</li>
                            <li>Portability.</li>
                            <li>Elimination of personal data (except in cases of legal obligations, such as keeping tax logs).</li>
                        </ul>

                        <h2>5. Retention Period</h2>
                        <p>
                            We keep registration information only for the time necessary to fulfill the purposes for which it was collected, respecting the prescription periods established by Brazilian legislation.
                        </p>

                        <h2>6. Information Sharing and Security</h2>
                        <p>
                            Your data is never sold. We only share strictly necessary information with technological sub-operators (e.g., cloud hosting providers like AWS or Azure, which have ISO 27001 certifications), adopting strict bank-grade confidentiality commitments (SSL 256 bits).
                        </p>

                        <h2>7. Cookies Used</h2>
                        <p>
                            We only use essential cookies for the fast and secure operation of the site, as well as analytics cookies activated only after your <em>Consent</em> through our Privacy Control Panel (Cookie Banner).
                        </p>

                        <h2>8. Contact the Data Protection Officer (DPO)</h2>
                        <p>If you have questions regarding the processing of personal data, please contact our Data Protection Officer (DPO) through the exclusive channel:</p>
                        <div className="bg-white p-6 rounded-xl border border-border mt-4">
                            <p className="m-0 text-sm"><strong>Name:</strong> Integrity & Compliance Team</p>
                            <p className="m-0 text-sm"><strong>Email:</strong> miola@nexusintell.com.br</p>
                            <p className="m-0 text-sm"><strong>Phone:</strong> +55 14 93618-0146</p>
                        </div>
